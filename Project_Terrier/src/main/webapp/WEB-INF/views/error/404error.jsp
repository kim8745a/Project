...
<html>
  ...
  <div class="content-container shadow">
    ...
    <div class="buttons-container">
      <a class="button" href="${pageContext.request.contextPath}/" target="_blank"><span class="fa fa-home"></span> Go To Home</a>
      <a class="button" href="javascript:history.back()" target="_blank"><span class="fa fa-warning"></span> Back</a>
    </div>
  </div>
</center>
